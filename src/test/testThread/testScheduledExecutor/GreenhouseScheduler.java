package test.testThread.testScheduledExecutor;
...
public class GreenhouseScheduler {
	...
	class WaterOff implements Runnable {
		@Override
		public void run() {
			System.out.println("Turning greenhouse water WaterOff");
			water = false;
		}
	}
	...
	class ThermostatNight implements Runnable {
		@Override
		public void run() {
			System.out.println("Thermostat to ninght setting");
			setThermostat("Night");
